...
const SchedulePage = ({ onNavigate }: Props) => {
  ...
  const checkConflicts = (course: ScheduledCourse) => {
    const conflicts = schedule.filter(otherCourse => {
      ...
      if (otherCourse.schedule_term !== course.schedule_term) return false;
  ...
  const filteredSchedule = schedule.filter(course => course.schedule_term === selectedTerm);
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center text-gray-700">
                  <Calendar className="w-5 h-5 text-amber-900 mr-3" />
                  <span className="font-medium text-lg">{selectedCourse.schedule_term}</span>
                </div>
              </div>
              ...
              {checkConflicts(selectedCourse) && (
                <div className="mb-6 p-4 bg-red-50 border border-red-300 rounded-lg">
                  ...
                  <p className="text-red-600 mb-3">
                    This course conflicts with other courses in your schedule for {selectedCourse.schedule_term}.
                  </p>
                    ...
                    <ul className="space-y-2">
                      {schedule
                        .filter(otherCourse => 
                          ...
                          otherCourse.schedule_term === selectedCourse.schedule_term &&
